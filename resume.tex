...
\secStartSpace
\begin{addmargin}[0.5em]{1em}
	\workHeader{University of Vienna}{Prae-Doc Assistant in the Theory and Applications of Algorithms (TAA) group}{Feb 2021 - Ongoing}
	\begin{itemize}
...
\de{
\section{\color{highlight}\textbf{Arbeitserfahrung}}
\secStartSpace
\begin{addmargin}[0.5em]{1em}
	\workHeader{Universit\"at Wien}{Prae-Doc Assistent in der Forschungsgruppe Theory and Applications of Algorithms (TAA)}{Feb 2021 - Laufend}
	\begin{itemize}
		\setlength{\itemsep}{0em}
...
\begin{addmargin}[0.5em]{1em}
	% ------------- project 1 ------------- %
	\projectHeader{XCut (published at KDD 2024)}{https://gitlab.com/vietaa/xcut}{May 2023 - Ongoing}{First practical algorithm using expander decomposition to cluster a graph.}

	\noindent XCut solves the normalized cut problem by sparsifying a graph to a tree and it is the current state of the art solver for this problem.
	Co-designed the algorithm, implemented it in \emph{C++}, and performed all experiments and data analysis using \emph{Python}. 
	...
	% ------------- project 2 ------------- %
	\projectHeader{PRONE (published at NeurIPS 2023)}{https://github.com/boredoms/prone}{February 2023 - Ongoing}{New algorithm for solving Euclidean $k$-means and creating coresets for downstream applications.}
		
	\noindent The algorithm has a running time of $O(nnz(A) + n \log n)$. 
	...
	Co-designed the algorithm, implemented it in \emph{C++} for preliminary experiments, analyzed and plotted data using \emph{pandas} and \emph{pyplot}, and provided result as a \emph{Python} package.
	% ------------- end project 2 ------------- %
\end{addmargin}
\secEndSpace
}
\de{
	...
	\begin{addmargin}[0.5em]{1em}
		% ------------- project 1 ------------- %
		\projectHeader{XCut (publiziert bei KDD 2024)}{https://gitlab.com/vietaa/xcut}{Mai 2023 - Laufend}{}
		...
		% ------------- project 2 ------------- %
		\projectHeader{PRONE (publizert bei NeurIPS 2023)}{https://github.com/boredoms/prone}{Februar 2023 - Laufend}{}
...
\begin{addmargin}[0.5em]{1em}
	\setstretch{1.125}
	\noindent \textbf{Languages} \hfill C++, Python, Haskell, Rust, German (native), English (fluent) \\
	\noindent \textbf{Technology} \hfill Linux, git, unix shell, cmake, poetry, clang-tidy, vim, Docker \\
	\noindent \textbf{Libraries} \hfill Blaze, OpenMP, OpenMPI, pandas, numpy, scikit-learn, pytorch
\end{addmargin}
\secEndSpace
}
\de{
...
\begin{addmargin}[0.5em]{1em}
	\setstretch{1.125}
	\noindent \textbf{Sprachen} \hfill C++, Python, Haskell, Rust, German (native), English (fluent) \\
	\noindent \textbf{Technologien} \hfill Linux, git, unix shell, cmake, poetry, clang-tidy, vim, Docker \\
	\noindent \textbf{Libraries} \hfill Blaze, OpenMP, OpenMPI, pandas, numpy, scikit-learn, pytorch
\end{addmargin}
\secEndSpace
}
