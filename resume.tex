...
\resumeSection{Work Experience}{
	...
	\begin{itemize}
		...
		\item Researched how tools from classical algorithm research can be used to design efficient algorithms for unsupervised learning objectives to speed up AI applications
...
\resumeSection{Projects}{
	\projectItem{XCut (published at KDD 2024)}{https://gitlab.com/vietaa/xcut}{May 2023 - Ongoing}{First practical algorithm using expander decomposition to cluster a graph.}{XCut solves the normalized cut problem by using new techniques for sparsifying a graph to a tree. It is the current state of the art solver for this problem.
		I co-designed, implemented and optimized the algorithm in C++, and performed all experiments and data analysis using \emph{Python}. 
	...
	\projectItem{PRONE (published at NeurIPS 2023)}{https://github.com/boredoms/prone}{February 2023 - Ongoing}{New algorithm for solving $k$-means in time $O(n \log n)$ and creating coresets for downstream applications.}{The algorithm is available as a \emph{Python} package, with its main implementation in \emph{C++}, and \emph{Cython} wrappers provided to make it available to data scientists working in Python. I co-designed, implemented and optimized the algorithm in C++, ran experiments, and performed the data analysis using Python.}
}
}
\de{
...
\resumeSection{Skills}{
	...
	\skillItem{Skills}{Linux, git, SQL, Docker, automated testing and profiling, CI/CD (Github Actions/GitLab CI),}\\
 	\skillItem{}{mathematical problem solving, research skills}\\
	\skillItem{Libraries}{OneTBB, OpenMP, OpenMPI, GTest, Catch2, pandas, numpy, scikit-learn, pytorch}
}
}
\de{
...
\ifthen{\boolean{personal}}{
	...
	\resumeSection{Personal Interests}{
		Bouldering, Analog and Digital Photography, Electronics, Playing the Guitar
	}
	}
	\de{
