...
\resumeSection{Arbeitserfahrung}{
	...
	\begin{itemize}
		\setlength{\itemsep}{0em}
		\item Forschung dar\"uber wie klassische Algorithmentheorie uns helfen kann effiziente Algorithmen f\"ur unsupervised Learning zu entwickeln
...
\resumeSection{Projekte}{
	\projectItem{XCut (publiziert bei KDD 2024)}{https://gitlab.com/vietaa/xcut}{Mai 2023 - Laufend}{
		Der erste Algorithmus f\"ur Graph-Clustering der auf Expanderzerlegung basiert.
	}{
	...
	\projectItem{PRONE (publizert bei NeurIPS 2023)}{https://github.com/boredoms/prone}{Februar 2023 - Laufend}{
		Ein neuer Algorithmus zum l\"osen des Euclidean $k$-means Problems und zum Erstellen von Coresets. 
	}{
		Die Laufzeit des Algorithmus ist $O(nnz(A) + n \log n)$. 
...
\resumeSection{Ausbildung}{
	\educationItem{Universit\"at Wien}{Februar 2021 - M\"arz 2025}{
	Dr. techn. Informatik\\
